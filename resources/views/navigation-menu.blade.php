        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @can('manage-users')
                    <x-jet-nav-link href="{{ url('admin/students') }}" :active="request()->routeIs('admin.students')">
                        {{ __('Students') }}
                    </x-jet-nav-link>
                    @endif

                    @if (auth()->user()->role_id == 2)
                        <x-jet-nav-link href="{{ route('student.grades.index') }}" :active="request()->routeIs('student.grades.index')">
                            {{ __('Grades') }}
                        </x-jet-nav-link>
                    @endif
