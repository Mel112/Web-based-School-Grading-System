    ...
    <div class="flex justify-center items-center h-screen bg-gray-800">
        <div class="flex flex-col md:flex-row md:max-w-xl rounded-lg bg-white shadow-xl">
          ...
          <div class="p-6 flex flex-col items-left">
            ...
            <h1 class="text-blue-500 text-6xl font-black mb-5 font-serif mt-5">403</h1>
            <h5 class="text-gray-900 text-xl font-bold mb-5">Hold Up! You are not allowed here!</h5>
            <p class="text-black text-base mb-5">
                You do not have the permission to view this directory or page using the credentials that you supplied.
            </p>
